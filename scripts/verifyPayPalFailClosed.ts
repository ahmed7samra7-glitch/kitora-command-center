...
try {
  ...
  assert.match(JSON.stringify(webhook), /refusing simulated capture/);

  console.log('PayPal fail-closed proof passed: missing credentials and untrusted capture cannot create or complete local payment records.');
} finally {
